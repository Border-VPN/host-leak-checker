...
- В CI (рекомендуется для приватных репозиториев) задайте секрет `SUBSCRIPTION_URL` в настройках репозитория (Settings → Secrets).
    Workflow передаст его как первый позиционный аргумент.
